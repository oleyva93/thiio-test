                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <v-menu>
                        <template v-slot:activator="{ props }">
                            <a class="nav-link dropdown-toggle" v-bind="props" href="#" role="button"
                        ...
                        <v-list>
                            <v-list-item>
                                <v-list-item-title><router-link :to="{ name: 'profile.index' }"
                                        class="dropdown-item">Profile</router-link></v-list-item-title>
                                <v-list-item-title>
                                    <v-divider></v-divider>
                                </v-list-item-title>
                                <v-list-item-title><a class="dropdown-item" :class="{ 'opacity-25': processing }"
                                        :disabled="processing" href="javascript:void(0)" style="cursor: pointer;"
                                        @click="logout">Logout</a></v-list-item-title>
                            </v-list-item>
                        </v-list>
                    </v-menu>
